				...
				<div class="card-body">
					...
					<div class="text-right">
						<a href="javascript:void(0)" data-toggle="modal"
							data-target="#modalGantiAlamat" class="btn btn-danger">Ganti
							Alamat</a>
					</div>
				</div>
			</div>
...
<!-- Modal Ganti Alamat -->
<div class="modal fade" id="modalGantiAlamat" tabindex="-1"
	role="dialog" aria-labelledby="exampleModalScrollableTitle"
	aria-hidden="true">
	<div class="modal-dialog modal-dialog-scrollable" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title" id="exampleModalScrollableTitle">Daftar
					Alamat Toko</h5>
				...
				<div class="card my-3" style="width: 100%;">
					<div class="card-body">
						...
						<div class="text-right my-3">
							<button type="button" onclick="perbaruiAlamat(0)" class="btn btn-danger">Perbarui
								Alamat</button>
				...
				<div class="card my-3" style="width: 100%;">
					<div class="card-body">
						...
						<div class="text-right mb-3">
							<button type="button" onclick="perbaruiAlamat(1)" class="btn btn-danger">Perbarui
								Alamat</button>
