        ...
        <div class="card-body">
            ...
            <div class="card my-3">
                <div class="card-body">
                    ...
                    <br>
                    <button class="btn btn-success w-100" data-toggle="modal" data-target="#exampleModal">Unggah Bukti Pembayaran</button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog" role="document">
            ...
            <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-footer">
                    ...
                    <a href="orderdetailconfirmed.html" type="button" class="btn btn-danger">Iya</a>
                </div>
            </div>
        </div>
    </div>