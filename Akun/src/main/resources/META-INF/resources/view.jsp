...
<div class="container mt-3 d-flex justify-content-start align-items-center">
            ...
            <div class="col-9">
                <div class="tab-content" id="v-pills-tabContent">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="text-muted">Nama Depan <span style="color:rgb(145, 0, 0)">*</span></label>
                                    <input type="text" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="text-muted">Email <span style="color:rgb(145, 0, 0)">*</span></label>
                                    <input type="text" class="form-control">
                                </div>
                            </div>
                            <div class="col-md-6">
                                ...
                                <br>
                                <div class="form-group">
                                    <label class="text-muted">Nama Belakang <span style="color:rgb(145, 0, 0)">*</span></label>
                                    <input type="text" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="text-muted">No. Telepon <span style="color:rgb(145, 0, 0)">*</span></label>
                                    <input type="text" class="form-control">
                                    <small id="emailHelp" class="form-text"><a style="color:rgb(145, 0, 0)" type="button" data-toggle="modal" data-target="#exampleModal">Verifikasi No Telepon?</a></small>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane fade" id="v-pills-profile" role="tabpanel" aria-labelledby="v-pills-profile-tab">
                        ...
                        <p class="text-muted">Daftar alamat toko yang dimiliki atau menambah alamat baru</p>
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex justify-content-between">
                                    <h5 class="card-title"><i class="fa fa-home"></i> Rumah</h5>
                                    <i style="color:rgb(145, 0, 0)" class="fa fa-trash"></i>
                                </div>
                                <h6 class="card-subtitle mb-2 text-muted">eka, 6282216649081</h6>
                                <h6 class="card-subtitle mb-2 text-muted">agungsam@gmail.com, , Kebon Jeruk, Jakarta Barat, Dki Jakarta -</h6>
                                <div class="text-right">
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#alamat">Perbarui Alamat</button>
                                </div>
                            </div>
                        </div>
                        <div class="text-right my-3">
                            <a data-toggle="collapse" href="#collapseExample" class="btn btn-danger">Tambah Alamat</a>
                        </div>
                        <div class="collapse" id="collapseExample">
                            <div class="card card-body">
                                <h5>Tambahkan Alamat Baru</h5>
                                <div class="form-group">
                                    <label class="text-muted">Nama Penerima <span style="color:rgb(145, 0, 0)">*</span></label>
                                    <input type="text" class="form-control">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="text-muted">Alamat <span style="color:rgb(145, 0, 0)">*</span></label>
                                    <input type="text" class="form-control">
                                </div>
                                <div class="form-group">
                                    <label class="text-muted">Provinsi <span style="color:rgb(145, 0, 0)">*</span></label>
                                ...
                                <div class="form-group">
                                    <label class="text-muted">Kabupaten <span style="color:rgb(145, 0, 0)">*</span></label>
                                    <select class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="text-muted">Kecamatan <span style="color:rgb(145, 0, 0)">*</span></label>
                                    <select class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="text-muted">Desa <span style="color:rgb(145, 0, 0)">*</span></label>
                                    <select class="form-control">
                                ...
                                <div class="form-group">
                                    <label class="text-muted">Kode Pos <span style="color:rgb(145, 0, 0)">*</span></label>
                                    <input type="text" class="form-control">
                                </div>
                                <div class="text-right">
                                    <a href="javascript:void(0)" class="btn btn-success">Simpan Alamat</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="tab-pane fade" id="v-pills-messages" role="tabpanel" aria-labelledby="v-pills-messages-tab">
                        <h2>Salesperson</h2>
                        <p class="text-muted mb-5">Data Salesperson yang mendaftarkan toko</p>
                        <div class="form-group">
                            <label class="text-muted">Kode Referal <span style="color:rgb(145, 0, 0)">*</span></label>
                            <input type="text" class="form-control">
                        </div>
                        <div class="text-right">
                            <button class="btn btn-danger">Simpan</button>
    ...
    <!-- Modal Verifikasi no telp -->
    <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Verifikasi No Telepon</h5>
            ...
            <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    <div class="container my-3 text-center" style="line-height: 70px;">
                        ...
                        <input type="text" class="form-control">
                        <p>Tekan <a href="javascript:void(0)">Kirim Kode</a> untuk menerima kode verifikasi No Telepon</p>
                    </div>
                </div>
        ...
        <div class="modal-dialog" role="document">
            ...
            <span aria-hidden="true">&times;</span>
                ...
                <div class="modal-body">
                    ...
                    <div class="text-right">
                        <a href="javascript:void(0)" class="btn btn-danger">Simpan Alamat</a>
                    </div>
                </div>
            </div>
        </div>
