...
<div style="background-image: url(https://qa.aksestoko.id/themes/aksestoko/assets/img/bg-sign.jpg);">

    <div class="card m-5 mx-auto" style="max-width: 600px;">
        <div class="card-header d-flex justify-content-between align-items-center">
            <div>
                <a href="index.html"><i style="color:#ccc;" class="fa fa-chevron-circle-left fa-2x"></i></a>
            </div>
            <div>
                <img src="https://qa.aksestoko.id/themes/aksestoko/assets/img/logo-at.png?v=4.5.20200226" style="width:150px" alt="">
            </div>
            <div></div>
        </div>
        <form>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="form-group">
                            <label>ID Bisnis Kokoh (9 Digit)</label>
                            <input onkeyup="cekIDBisnisKokoh()" id="inputIDBK" type="text" class="form-control" required>
                        </div>
                        <div class="collapse" id="collapseExample">
                            ...
                            <div class="form-group">
                                <label>Punya kode referal Salesperson?</label>
                                <input type="text" class="form-control" required placeholder="Kode Referal">
                            </div>
                            <div class="form-group form-check">
                                <input type="checkbox" class="form-check-input" id="exampleCheck1">
                                <label class="form-check-label" for="exampleCheck1">Saya sudah membaca dan menyetujui Syarat dan
