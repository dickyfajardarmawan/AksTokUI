...
<div class="container mt-3 d-flex justify-content-start align-items-center">
    ...
    <div class="container">
        <div class="alert alert-danger" role="alert">
            Sisa Durasi Waktu Pembayaran : 31 Hari
        </div>
        <div class="row">
            <div class="col-md-5">
                <div class="card my-3">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <p><b>Pengiriman Distributor</b></p>
                            <p><b>Tempo dengan Distributor</b></p>
                        </div>
                        <hr>
                        <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex justify-content-between align-items-center">
                            <p class="text-success"><b>Diterima</b></p>
                            <p class="text-primary"><b>Diterima Sebagian</b></p>
                        </div>
                        <div class="text-right">
                            <a class="btn btn-success" href="/pelunasan">Selesaikan Pembayaran</a>
                            <br>
                            <br>
                            <button class="btn btn-secondary" data-toggle="modal" data-target="#exampleModal"><i class="fa fa-list-alt" ></i> Daftar Pembayaran</button>
                        </div>
                    </div>
                </div>
                <div class="card my-3">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <p><b>Jumlah Diterima</b></p>
                            </div>
                            <div class="col-md-3">
                                <p><b>Sisa Pesanan</b></p>
                            </div>
                        </div>
            ...
            <div class="col-md-7">
                <div class="card my-3" style="width: 100%;">
                    <div class="card-body">
                        ...
                        <div class="card my-3" style="width: 100%;">
                            <div class="card-body">
                                <h5 class="card-title"><i class="fa fa-home"></i> Kantor</h5>
                        ...
                        <div class="card my-3" style="width: 100%;">
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <p><b>DO/2020/03/0002</b></p>
                                    <p class="text-success"><b>Barang Diterima</b></p>
                                </div>
                                <div class="d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <p><b>06 Februari 2020</b></p>
                                    <p><b>-</b></p>
                                </div>
                                <div class="text-center">
                                    <button class="btn btn-danger"><i class="fa fa-download"></i> Unduh SPJ</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>Rp. 20.000</td>
                                <td>Diterima</td>
                                <td><a target="_blank" href="https://ecs7.tokopedia.net/img/cache/700/product-1/2018/12/9/12686084/12686084_daab4d93-3fbe-45ce-9b2c-d499e090a72d_1187_1899.jpg" class="btn btn-danger"><i class="fa fa-file-image-o"></i> Bukti Pembayaran</a></td>
                            </tr>
                        </tbody>
                    </table>
                    <hr>
