        ...
        <div class="container my-3">
            <div class="card">
                <div style="background-color:#830000;color:#fff" class="card-header">
                    <h4 class="m-0"><i class="fa fa-list-alt"></i> Role</h4>
                </div>
                <div class="card-body">
                    <form>
                        <div class="row">
                            ...
                            <div class="col text-right">
                                <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal5"><i class="fa fa-plus"></i> Tambahkan Role Baru</button>
                            </div>
                        </div>
                    </form>
                    <table class="table">
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group row">
                                <label for="staticEmail" class="col-sm-2 col-form-label">Nama Role</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" disabled>
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="inputPassword" class="col-sm-2 col-form-label">Pilih Aplikasi</label>
                                <div class="col-sm-10">
